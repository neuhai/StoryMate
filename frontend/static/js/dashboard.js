...
function setStat(){
    ...
    document.getElementById('nowReading').innerHTML =  `<p1>正在阅读的书是：</p1>
                                                        <p2>${bookTitle}</p2>
    ...
    for(var key in bookDict){
        ...
        <div class="tableHeader" id='header_${table_id}'>
            <div class="header-cell">
                ...
                <div class="conceptInst">${bookDict[key].count}个科学知识点</div>
                <div class="progressCircle">
                    <p>${Math.round(100*curLen/bookDict[key].count)} %</p>
                    <svg class="progress-circle" width="100%" height="100%">
                        <circle cx="50%" cy="50%" r="30"></circle>
                        <circle cx="50%" cy="50%" r="30" class="progress-bar"></circle>
                    </svg>
                </div>
            </div>
